...
import python from "../assets/pythonlearnpeakimg.jpg";// replace with your image path
...
const Python = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Python Programming - LearnPeak</title>
        <meta
          name="description"
          content="Learn Python programming with interactive exercises, visual examples, and interview preparation."
        />
        <meta
          name="keywords"
          content="Python, LearnPeak, Python Tutorials, Visual Python, Python Theory, Python Interviews"
        />
        <link rel="canonical" href="https://elearning-platform-zksp.vercel.app/python" />
      </Helmet>
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <div className="flex items-center space-x-4">
            <input
              ...
              className="bg-transparent border border-gray-700 rounded-lg py-2 px-4 text-sm w-64 focus:border-yellow-500 outline-none"
            />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center mb-14">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-white/10
            ...
            <div className="absolute inset-0 p-10 flex flex-col justify-center bg-black/40">
              <span className="text-sm font-semibold text-yellow-300 border border-yellow-400 py-1 px-3 rounded-full mb-4 inline-flex w-fit">
                Python Programming
              </span>
              ...
              <p className="text-gray-200 text-lg md:text-xl mb-6 max-w-xl">
                Master Python with visual examples, theory, and practical exercises.
              </p>
          ...
          <div className="w-full bg-[#11072d] rounded-2xl p-6 border border-white/10 shadow-lg">
            ...
            <button className="mt-4 w-full bg-yellow-600 py-2 rounded-lg text-sm shadow-md">
              View Schedule
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-green-400/60 to-green-600/60 
            ...
            <p className="text-sm text-white/90 mb-4">
              Dive into Python with interactive coding exercises, live demos, and real-world examples.
            </p>
            <button
              onClick={() => navigate("/pythonvl")}
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-400/60 to-blue-600/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
            <h2 className="text-xl font-bold mb-1 text-white drop-shadow">Theoretical Learning</h2>
            <p className="text-sm text-white/90 mb-4">
              Learn Python fundamentals, advanced topics, and prepare for coding interviews.
            </p>
            <button
              onClick={() => navigate("/pythonIq")}
