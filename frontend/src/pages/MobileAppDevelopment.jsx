...
const MobileAppDevelopment = () => {
  ...
  return (
    <>
      {/* Helmet for SEO */}
      <Helmet>
        <title>Mobile App Development | LearnPeak</title>
        <meta
          name="description"
          content="Learn Mobile App Development with LearnPeak. Explore UI/UX, Flutter, React Native, iOS & Android development, and interview preparation."
        />
        <meta
          name="keywords"
          content="Mobile App Development, LearnPeak, UI/UX, Flutter, React Native, iOS, Android, Interview Prep"
        />
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-400/60 to-purple-400/60 
