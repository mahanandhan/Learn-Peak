    ...
    <>
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-white/10
            ...
            <div className="absolute inset-0 p-10 flex flex-col justify-center bg-black/40">
              ...
              <p className="text-gray-200 text-lg md:text-xl mb-6 max-w-xl">
                Master Data Science with visualizations, theory, and practical exercises.
              </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-fuchsia-400/60 to-purple-500/60 
            ...
            <p className="text-sm text-white/90 mb-4">
              Dive into data visualization techniques, learning to interpret graphs, charts, and infographics.
            </p>
            <button
              onClick={() => navigate("/datasciencevl")}
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-lime-400/60 to-green-500/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
            <h2 className="text-xl font-bold mb-1 text-white drop-shadow">Interview Preparation</h2>
            <p className="text-sm text-white/90 mb-4">
              Prepare for data science interviews with theoretical knowledge and practical scenarios.
            </p>
            <button
              onClick={() => navigate("/DataScienceIq")}
