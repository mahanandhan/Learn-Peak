...
const Java = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Java Programming - LearnPeak</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Java, LearnPeak, Java Tutorials, Visual Java, Java Theory, Java Interviews"
        />
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-teal-400/60 to-teal-600/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
