...
// IMPORT CYBERSECURITY IMAGE
import Cyber from "../assets/cybersecuritylearnpeakimg.png";
    ...
    <>
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-white/10
            ...
            <div className="absolute inset-0 p-10 flex flex-col justify-center bg-black/40">
              ...
              <p className="text-gray-200 text-lg md:text-xl mb-6 max-w-xl">
                Learn cybersecurity with interactive visuals and practical scenarios.
              </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-400/60 to-cyan-400/60 
            ...
            <p className="text-sm text-white/90 mb-4">Learn cybersecurity through visuals and hands-on exercises.</p>
            <button
              onClick={() => navigate("/cybersecurityvl")}
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-yellow-400/60 to-orange-500/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
            <h2 className="text-xl font-bold mb-1 text-white drop-shadow">Interview Preparation</h2>
            <p className="text-sm text-white/90 mb-4">Prepare for interviews with theoretical knowledge and practical scenarios.</p>
            <button
              onClick={() => navigate("/CyberSecurityIq")}
