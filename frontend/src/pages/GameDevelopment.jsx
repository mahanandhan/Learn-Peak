...
const GameDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Game Development - LearnPeak</title>
        <meta
          name="description"
          content="Master Game Development with LearnPeak. Explore visual tutorials, theory, and interview preparation for aspiring game developers."
        />
        <meta
          name="keywords"
          content="Game Development, LearnPeak, Game Design, Engine Programming, 3D Visuals, Game Interviews, Visual Learning"
        />
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-green-400/60 to-teal-500/60 
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-indigo-400/60 to-purple-500/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
