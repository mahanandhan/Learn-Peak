...
const UiUx = () => {
  ...
  return (
    <>
      <Helmet>
        <title>UI/UX Design - LearnPeak</title>
        <meta
          name="description"
          content="Master UI/UX Design with LearnPeak. Learn visual design, prototyping, and interview preparation for aspiring designers."
        />
        <meta
          name="keywords"
          content="UI UX Design, LearnPeak, User Interface, User Experience, Design Tutorials, UI UX Interviews, Visual Design"
        />
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-yellow-400/60 to-yellow-500/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
