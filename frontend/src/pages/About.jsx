...
const About = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 font-sans text-gray-800">
      <h1 className="text-3xl font-bold mb-6 text-indigo-700 text-center">About LearnPeak</h1>
      <p className="mb-4 text-lg">
        LearnPeak is an innovative e-learning platform designed to help learners master
      ...
      <p className="mb-4 text-lg">
        LearnPeak emphasizes interactive learning, practical problem solving, and
      ...
      <p className="mb-4 text-lg">
        ...
        deepen your understanding of computer science fundamentals, LearnPeak is
