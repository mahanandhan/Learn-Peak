    ...
    <>
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="flex justify-between items-center mb-10">
          <h2 className="text-2xl font-semibold text-gray-300">Gaston</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-400 to-cyan-400 text-black">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-400 to-purple-500 text-white">
