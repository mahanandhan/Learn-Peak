...
                    className="flex-shrink-0 w-64 md:w-80 relative bg-gray-900 rounded-xl shadow-xl transform transition duration-300 hover:scale-[1.02] cursor-pointer overflow-hidden border border-gray-800 block" 
                  >
                    {/* Glowing Border Effect for Cards */}
                    <div className={`absolute inset-0 m-[-1px] rounded-xl bg-gradient-to-r ${getCardGradient(index)} opacity-30 blur-sm`}></div>
                    
